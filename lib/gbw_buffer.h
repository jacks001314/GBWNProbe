...
typedef struct gbw_buffer_t gbw_buffer_t;
...
static inline int gbw_buffer_init(gbw_buffer_t *bf){
...
static inline int gbw_buffer_init2(gbw_buffer_t *bf,size_t bsize){
...
#define gbw_buffer_need_update(bf,nsize) ((bf)->b_current_size<nsize) 

static inline int gbw_buffer_update(gbw_buffer_t *bf,size_t nsize) {
