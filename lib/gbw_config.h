...
typedef struct gbw_configfile_t gbw_configfile_t;
struct gbw_configfile_t {
    /**< an gbw_file_getc()-like function */
    int (*getch) (char *ch, void *param);
    /**< an gbw_file_gets()-like function */
...
struct cmd_parms_struct {
    ...
    gbw_configfile_t *config_file;

    /** Pool to allocate new storage in */
    gbw_pool_t *pool;
    /** Pool for scratch memory; persists during configuration, but
     *  wiped before the first request is served...  */
    gbw_pool_t *temp_pool;
...
/**
 * Open a gbw_configfile_t as gbw_file_t
 * @param ret_cfg open gbw_configfile_t struct pointer
...
/**
 * Read one line from open gbw_configfile_t, strip leading and trailing
 ...
 */
int gbw_cfg_getline(char *buf, size_t bufsize, gbw_configfile_t *cfp);


/**
 * Detach from open gbw_configfile_t, calling the close handler
